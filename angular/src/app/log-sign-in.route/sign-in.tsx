...
import { SIGNIN_USER } from "../API/users/signin.users"
	...
	return (
		<form className='lg:mt-6 lg:px-[0.5em] lg:py-[2em] shadow-none lg:shadow-md relative flex flex-col gap-[4vh]'>
			<div className='flex flex-col justify-center align-middle items-center'>
				<label htmlFor='text' className='def-theme-text'>
					NickName
				</label>
				<input
					id='text'
			...
			<div className='flex justify-center items-center flex-col gap-[2vh] lg:gap-4'>
				...
				<button
					...
					onClick={() => {
						event!.preventDefault()
						makeRouteCall("PrivatePolicyRules")
					}}>
					Private Policy & Community Rules
				</button>
				<motion.button
					onClick={() => {
						onSubmit()
